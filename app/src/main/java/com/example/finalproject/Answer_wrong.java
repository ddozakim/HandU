...
public class Answer_wrong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double randomValue = generateRandomValue(0.01, 0.20);
        ...
        hand.postDelayed(new Runnable() {
            ...
            public void run() {
                if("word".equals(mode)){
                    Intent intent_W = new Intent(Answer_wrong.this, waiting_WordMode.class);
                    startActivity(intent_W);
                    finish();
                }
                else if("alphabet".equals(mode)){
                    Intent intent_A= new Intent(Answer_wrong.this, waiting_AlphabetMode.class);
                    startActivity(intent_A);
                    finish();
                }
                else if("number".equals(mode)){
                    Intent intent_N = new Intent(Answer_wrong.this, waiting_NumberMode.class);
