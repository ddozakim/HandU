...
public class Answer_Number_correct extends AppCompatActivity {
    float confidence;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_answer_number_correct);
        ...
        hand.postDelayed(new Runnable() {
            ...
            public void run() {
                if(mode==0){
                    Intent intent_N = new Intent(Answer_Number_correct.this, waiting_NumberMode.class);
                    startActivity(intent_N);
                    finish();
                }
                else if(mode==1){
                    Intent intent_N = new Intent(Answer_Number_correct.this, waiting_AlphabetMode.class);
                    startActivity(intent_N);
                    finish();
                }
